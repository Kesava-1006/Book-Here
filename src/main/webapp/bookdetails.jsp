...
<meta charset="UTF-8">
    ...
    <title>Products-Book-Here</title>
...
<div class="row">
    <div class="col-2">
        <img src="image1?id=<c:out value='${book.id}' ></c:out>" style="padding: "100px" id="ProductImg">
        <div class="small-img-row">
        <table>
        	<tr>
        		<td><img src="image1?id=<c:out value='${book.id}' ></c:out>"  class="small-img"></td>
        		<td><img src="image2?id=<c:out value='${book.id}' ></c:out>"  class="small-img"></td>
        		<td><img src="image3?id=<c:out value='${book.id}' ></c:out>"  class="small-img"></td>
        		<td><img src="image4?id=<c:out value='${book.id}' ></c:out>"  class="small-img"></td>
